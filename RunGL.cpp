...
srand(time(0));
        ...
        for(int i = 1; i < NUMBER_OF_BACKGROUND_MODELS+1; i++)
        {
              ...
              collisionBoxArray[i][2]          =  0.0;                         //_POSITION[2]
              //----------------------------              
              collisionBoxArray[i][3]          =  1.0;                         //_SCALE[0];
              collisionBoxArray[i][4]          =  1.0;                         //_SCALE[1];
              collisionBoxArray[i][5]          =  1.0;                         //_SCALE[2];
              //----------------------------          
              collisionBoxArray[i][6]          =  float((rand()% 10)-5) *.03;  //_VELOCITY[0];
              collisionBoxArray[i][7]          =  float((rand()% 10)-5) *.03;  //_VELOCITY[1];     
              collisionBoxArray[i][8]          =  0.0;                         //_VELOCITY[2];               
              //----------------------------
